...
int adjustEvalWithCorrHist(ThreadData &thread,Stack *ss, const int rawEval) {
    ...
    const int average = (47*pawnCorrHistEntry + 49*nonPawnCorrHistEntryWhite + 55*nonPawnCorrHistEntryBlack + contcorrHistEntry*30 +threatLastMoveCorrHistEntry*30)/ 512;
